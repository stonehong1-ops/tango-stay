export default {
  ...
  gallery: {
    more: 'Xem thêm ảnh',
    categories: ['Tất cả', 'Phòng khách', 'Phòng ngủ', 'Bếp', 'Phòng tắm', 'Tầm nhìn'],
    descriptions: [
  ...
  calendar: {
    ...
    available: 'Còn phòng',
    selected: 'Đã chọn',
    priceInfo: 'Nhận phòng thông minh / Cơ bản 2 khách (Tối đa 3)',
    basePrice: 'Ngày thường: 90,000 KRW / Cuối tuần: 120,000 KRW',
    totalPrice: 'Tổng chi phí',
    surcharge: 'Đã bao gồm phụ phí Cuối tuần/Ngày lễ',
    clearBtn: 'Chọn lại ngày',
    days: 'Đêm',
    won: 'KRW',
    blockedAlert: '[Đã hết phòng]\nKhách:',
    period: 'Thời gian:',
    invalidRange: 'Khoảng thời gian bạn chọn bao gồm các ngày đã được đặt. Vui lòng thử lại.',
    hintSelectOut: 'Vui lòng chọn ngày trả phòng!',
    feeGuideTitle: 'Hướng dẫn giá cả',
    feeGuideLines: [
    ...
    hintSelectDates: 'Chọn ngày trên lịch để xem chính xác tổng chi phí.',
    guestSelectLabel: 'Số khách',
    guestOptions: ['1 Khách (Cơ bản)', '2 Khách (+10k/đêm)', '3 Khách (+20k/đêm)', '4 Khách (Tối đa, +30k/đêm)'],
    finalPriceTitle: 'Tổng chi phí cuối cùng',
    baseFee: 'Giá phòng cơ bản',
  ...
  location: {
    ...
    naver: 'Mở bằng Naver Map',
    kakao: 'Mở bằng Kakao Map'
  },
  intro: {
    ...
    hostBio: 'Tôi theo học chuyên ngành Quản trị Kinh doanh và Trí tuệ Nhân tạo, đồng thời từng làm người lập kế hoạch chính cho nhiều ứng dụng nổi tiếng mà bạn có thể sử dụng hàng ngày.\n\nGần đây, tôi đã rời bỏ cuộc sống công sở để cống hiến phần đời còn lại với tư cách là người hướng dẫn và nghiên cứu Tango. Để tạo ra những trải nghiệm lưu trú tuyệt vời, tôi đã và đang chuẩn bị cho cơ sở thứ nhất và thứ hai của mình. Nếu bạn có bất kỳ điều gì không thoải mái, vui lòng cho tôi biết và tôi sẽ tiếp tục cải thiện không gian.'
  },
  guide: {
    ...
    acc1Title: '✨ Điểm nổi bật của phòng',
    acc1List: [
      { t: 'Công trình mới xây cao cấp với tầm nhìn thoáng đãng', d: 'Tận hưởng tầm nhìn tuyệt đẹp ra sông Hàn từ căn hộ mới nhất và sạch nhất trong khu vực Hapjeong/Hongdae.' },
      { t: 'Vệ sinh tuyệt đối', d: 'Chăn ga gối đệm và thảm trải sàn được giặt sạch chuyên nghiệp bởi Laundrygo mỗi lần. Vệ sinh hơi nước trong nhà, và tất cả khăn tắm/khăn lau được thay thế mới 100%.' },
      { t: 'Nội thất thư giãn cao cấp', d: 'Hai chiếc giường rộng rãi (Queen, Super Single), sofa ấm cúng và ghế massage thư giãn hiệu suất cao.' },
      { t: 'Giải trí phong phú', d: 'Phòng khách có Samsung Moving Style Smart TV 2026, cùng một chiếc TV bổ sung trong phòng ngủ.' }
    ],
    quote1: '"Hãy tận hưởng ghế massage trong khi ngắm nhìn cảnh đêm sông Hàn~"',
    acc2Title: '📍 Vị trí & Giao thông thuận tiện (Gửi xe miễn phí)',
    acc2List: [
      { t: 'Vị trí đắc địa', d: '1 phút đi bộ đến ga Hapjeong. Truy cập nhanh đến Hongdae/Sinchon bằng đi bộ/tàu điện/xe buýt (10 phút đi bộ đến Hongdae).' },
      { t: 'Trung tâm giao thông', d: 'Điểm hội tụ của tất cả các tuyến xe buýt di chuyển khắp Seoul. (Ga Mangwon, ga Hongdae đều liền kề)' },
      { t: 'Chỗ đậu xe thuận tiện', d: 'Mang theo xe của bạn và đậu xe miễn phí. (Chủ nhà chi trả toàn bộ phí gửi xe hàng tháng 30,000 KRW)' },
      { t: 'Lái xe & Taxi', d: 'Chỉ mất 1 phút để vào đường cao tốc ven sông Gangbyeon đi Gangnam, Ilsan, Yeouido.' }
    ],
    acc3Title: '🛋️ Tiện nghi & Cơ sở vật chất (Vật dụng tiêu hao miễn phí)',
    baseOptions: 'Thiết bị gia dụng/Nội thất cơ bản',
    baseOptionsDesc: 'Tủ lạnh, Máy giặt, Điều hòa, Smart TV (2), Wi-Fi Giga, Bồn rửa, Bếp từ, Giường Queen & Super Single',
    addOptions: 'Cơ sở vật chất bổ sung',
    addOptionsDesc: 'Khóa cửa an toàn, Văn phòng quản lý/CCTV, Bàn ăn, Máy lọc nước, Sofa, Bàn làm việc lớn, Tủ quần áo rộng rãi, Tủ giày',
    ...
    acc4Title: '🛡️ Quy định phòng & Liên lạc với chủ nhà',
    acc4List: [
      { t: '🔓 Nhận phòng / Trả phòng (Linh hoạt)', d: 'Tự nhận phòng không tiếp xúc. Mật khẩu và thông tin phòng được gửi qua tin nhắn vào ngày nhận phòng.\nTiêu chuẩn: Nhận phòng 15:00 / Trả phòng 11:00 (Có thể điều chỉnh để thuận tiện cho bạn!)' },
      { t: '🏠 Quy định nghiêm ngặt', d: 'Tuyệt đối KHÔNG HÚT THUỐC trong toàn bộ tòa nhà. Phí dọn dẹp đặc biệt sẽ được áp dụng nếu vi phạm.\nVui lòng phân loại rác và rửa bát đĩa trước khi trả phòng.\nVì đây là căn hộ mới xây, vui lòng hạn chế tiếng ồn lớn sau 22:00.' },
      { t: '🤩 Liên lạc với chủ nhà 24/7', d: 'Liên hệ với tôi bất cứ lúc nào, kể cả sáng sớm! Đừng ngần ngại nhắn tin nếu bạn thấy không thoải mái.\nNếu bạn thiếu bất kỳ vật dụng thiết yếu nào trong thời gian lưu trú, hãy cho tôi biết. Tôi sẽ mua và giao chúng ngay trong ngày.' }
    ],
    acc5Title: '🛍️ Lối sống & Điểm tham quan xung quanh',
    acc5List: [
      { t: 'Khu vực Hapjeong / Hongdae', d: 'Liền kề những nhà hàng và quán cà phê tốt nhất ở Hapjeong và những con phố sôi động ở Hongdae.' },
      { t: 'Siêu thị tiện lợi', d: 'Wang Mart cách 1 phút cho việc mua sắm nhanh. Siêu thị Homeplus Mega Mart cách 5 phút đi bộ cho mọi thứ khác.' },
      { t: 'Thư giãn tại sông Hàn bất cứ lúc nào', d: '1 phút đi bộ đến lối vào công viên Hangang. Kết nối chặt chẽ với công viên hồ Mangwon.' }
    ]
  },
  contact: {
    title: 'Liên hệ',
  ...
  reserve: {
    ...
    nameLabel: 'Tên khách',
    namePlace: 'Nhập tên đầy đủ của bạn',
    phoneLabel: 'Liên hệ',
    phonePlace: '010-0000-0000',
    guestLabel: 'Số lượng khách',
    guests: 'Khách',
    reqLabel: 'Yêu cầu',
    reqPlace: 'Bạn có yêu cầu đặc biệt hay câu hỏi nào không?',
    submitBtn: 'Gửi yêu cầu đặt phòng',
    submitting: 'Đang xử lý...',
    errorFill: 'Vui lòng điền tên, liên hệ và số lượng khách.',
    errorFail: 'Đã xảy ra lỗi trong quá trình xử lý.'
  },
  complete: {
    title: 'Đặt phòng hoàn tất! 🎉',
    desc: 'Hướng dẫn thanh toán và nhận phòng sẽ sớm được gửi đến số điện thoại liên hệ của bạn.',
    guideBtn: 'Xem trước hướng dẫn sử dụng',
