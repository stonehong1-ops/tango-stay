export default {
  ...
  gallery: {
    ...
    descriptions: [
      ...
      'Purificatore d\'acqua, utensili da cucina, condimenti, usa e getta completamente attrezzati',
  ...
  calendar: {
    ...
    surcharge: 'Include supplemento fine settimana/festività',
    clearBtn: 'Cancella selezione',
    days: 'Notti',
    won: 'KRW',
    blockedAlert: '[Tutto Esaurito]\nOspite:',
    period: 'Periodo:',
    invalidRange: 'L\'intervallo selezionato include date già prenotate. Per favore, riprova.',
    hintSelectOut: 'Per favore, seleziona una data di check-out!',
    ...
    baseFee: 'Tariffa base per notte',
    guestFee: 'Supplemento ospite extra',
    weekendFee: 'Supplemento fine settimana/festività',
    cleaningFee: 'Spese di pulizia',
    longStayDiscount: 'Sconto per soggiorno lungo',
  ...
  intro: {
    ...
    sol3Text: 'Tutta la biancheria da letto (piumone, copripiumino, coprimaterasso, federe) e i tappeti vengono preparati in duplice copia e lavati professionalmente e sterilizzati ad alta temperatura da Laundrygo per ogni nuovo ospite. Sperimenta un sonno profondo su biancheria impeccabilmente pulita.',
    ...
    hostBio: 'Mi sono specializzato in Business Administration e Intelligenza Artificiale, e ho lavorato come lead planner per molte app famose che probabilmente usi ogni giorno.\n\nRecentemente, ho lasciato la vita aziendale per dedicare il resto della mia vita come istruttore e ricercatore di Tango. Per creare esperienze di soggiorno meravigliose, sto preparando la mia 1ª e 2ª succursale. Se mai ti senti a disagio, fammelo sapere e continuerò a migliorare lo spazio.'
  },
  guide: {
    ...
    acc1Title: '✨ Punti salienti della camera',
    acc1List: [
    ...
    quote1: '"Goditi la poltrona massaggiante guardando la vista notturna del fiume Han~"',
    acc2Title: '📍 Posizione e trasporti convenienti (Parcheggio gratuito)',
    acc2List: [
      { t: 'Posizione super privilegiata', d: '1 min a piedi dalla stazione di Hapjeong. Accesso rapido a Hongdae/Sinchon a piedi/metro/autobus (10 min a piedi da Hongdae).' },
    ...
    acc3Title: '🛋️ Servizi e strutture (Materiali di consumo gratuiti)',
    baseOptions: 'Elettrodomestici/Mobili di base',
    baseOptionsDesc: 'Frigorifero, lavatrice, aria condizionata, Smart TV (2), Wi-Fi Giga, lavabo, fornello a induzione, letti Queen e Super Single',
    addOptions: 'Strutture aggiuntive',
    addOptionsDesc: 'Serratura sicura, ufficio di gestione/CCTV, tavolo da pranzo, purificatore d\'acqua, divano, scrivania grande, armadio spazioso, scarpiera',
    ...
    acc4Title: '🛡️ Linee guida della camera e comunicazione con l\'host',
    acc4List: [
    ...
    acc5Title: '🛍️ Stile di vita del quartiere e attrazioni',
    acc5List: [
  ...
  reserve: {
    ...
    guests: 'Ospiti',
    reqLabel: 'Richieste',
    reqPlace: 'Hai richieste speciali o domande?',
    submitBtn: 'Invia Prenotazione',
    submitting: 'In elaborazione...',
    errorFill: 'Per favore completa nome, contatto e numero di ospiti.',
    errorFail: 'Si è verificato un errore durante l\'elaborazione.'
  },
  complete: {
    title: 'Prenotazione Completata! 🎉',
    desc: 'Le istruzioni per il pagamento e il check-in verranno inviate a breve al tuo numero di contatto.',
    guideBtn: 'Anteprima della Guida all\'Uso',
